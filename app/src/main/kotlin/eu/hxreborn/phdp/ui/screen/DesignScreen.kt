                    ...
                    items = listOf(
                        {
                            ColorPreference(
                                ...
                                title = { Text(stringResource(R.string.active_progress)) },
                                summary = { Text(stringResource(R.string.active_progress_desc)) },
                            )
                        },
                        {
                            ColorPreference(
                                ...
                                title = { Text(stringResource(R.string.on_completion)) },
                                summary = { Text(stringResource(R.string.on_completion_desc)) },
                            )
                        },
                    ),
                )
                    ...
                    items = listOf(
                        {
                            SliderPreferenceWithReset(
                                ...
                                title = { Text(stringResource(R.string.ring_thickness)) },
                                summary = { Text(stringResource(R.string.ring_thickness_desc)) },
                        ...
                        },
                        {
                            SliderPreferenceWithReset(
                                ...
                                title = { Text(stringResource(R.string.camera_gap)) },
                                summary = { Text(stringResource(R.string.camera_gap_desc)) },
                        ...
                        },
                        {
                            SliderPreferenceWithReset(
                                ...
                                title = { Text(stringResource(R.string.opacity)) },
                                summary = { Text(stringResource(R.string.opacity_desc)) },
                    ...
                    items = listOf(
                        {
                            TogglePreferenceWithIcon(
                                ...
                                title = { Text(stringResource(R.string.percent_text)) },
                                summary = { Text(stringResource(R.string.percent_text_desc)) },
                            )
                        },
                        {
                            SelectPreference(
                                ...
                                title = { Text(stringResource(R.string.percent_text_position)) },
                                summary = { Text(stringResource(R.string.percent_text_position_desc)) },
                    ...
                    items = listOf(
                        {
                            TogglePreferenceWithIcon(
                                ...
                                title = { Text(stringResource(R.string.filename_text)) },
                                summary = { Text(stringResource(R.string.filename_text_desc)) },
                            )
                        },
                        {
                            SelectPreference(
                                ...
                                title = { Text(stringResource(R.string.filename_text_position)) },
                                summary = { Text(stringResource(R.string.filename_text_position_desc)) },
...
private fun positionLabelPlain(position: String): String = when (position) {
    "left" -> "Left"
    "right" -> "Right"
    "top_left" -> "Top Left"
    "top_right" -> "Top Right"
